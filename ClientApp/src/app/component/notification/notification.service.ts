...
import { SHRIEK_NOTIFICATION_DATA, NotificationConfig } from './notification.config';
import { NotificationRef } from './notification.ref';
import { NotificationComponent } from './notification.component';
import { NotificationContainer } from './notification-container';

export const SHRIEK_NOTIFICATION_DEFAULT_OPTIONS = new InjectionToken<NotificationConfig>('notification-default-options');
...
export class NotificationService {
  ...
  constructor(
    ...
    @Inject(SHRIEK_NOTIFICATION_DEFAULT_OPTIONS) private _defaultConfig: NotificationConfig) {
  }
  ...
  private _createInjector<T>(config: NotificationConfig, notificationRef): PortalInjector {
    ...
    injectionTokens.set(SHRIEK_NOTIFICATION_DATA, config.data);
