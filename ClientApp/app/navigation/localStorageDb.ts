...
export class localStorageDb {
  ...
  constructor(name) {
    ...
    // this.add({ id: 1, name: 'shriek-1', createTime: 1234 });
    // this.add({ id: 2, name: 'shriek-2', createTime: 1111 });
    // this.where({ id: 2 }).update({ name: 'test' });
    // this.where({ id: 2, name: 'shriek-2' }).update({ name: 'test' });
    // this.where({ id: 1 }).delete();
    // this.where({ id: 2 }).delete();
    // this.where({ id: 2, name: 'shriek-2' }).delete();
    // this.where({ id: 1 }).find();
    // this.where({ id: 2, name: 'shriek-2' }).find();
    // this.select();
  }
